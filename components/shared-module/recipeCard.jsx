...
const RecipeCard = ({
  ...
  const titleFontSize =
    duration && difficulty
      ? "text-mtitleSmall lg:text-mtitleSmall xl:text-ctitle mb-2 lg:mb-4"
  ...
  return (
    <div className={`relative transition-all hover:rotate-3 hover:shadow-lg duration-300 rounded-3xl overflow-hidden aspect-[4/5] ${className}`}>
      <FancyLink
        destination={link}
